...
import { ExecaChildProcess, ExecaOptions, type PackageManagerController } from '@aws-amplify/plugin-types';
/**
...
export declare abstract class PackageManagerControllerBase implements PackageManagerController {
    ...
    protected readonly executeWithDebugLogger: (cwd: string, executable: string, args?: readonly string[] | undefined, execa?: import("execa").ExecaMethod<{}>, options?: ExecaOptions | undefined) => import("execa").ResultPromise<import("execa").Options>;
    protected readonly existsSync: typeof _existsSync;
    protected readonly binaryRunner: string;
    /**
     * constructor - sets the project root
     */
    constructor(cwd: string, executable: string, initDefault: string[], installCommand: string, fsp?: typeof _fsp, path?: _path.PlatformPath, execa?: import("execa").ExecaMethod<{}>, executeWithDebugLogger?: (cwd: string, executable: string, args?: readonly string[] | undefined, execa?: import("execa").ExecaMethod<{}>, options?: ExecaOptions | undefined) => import("execa").ResultPromise<import("execa").Options>, existsSync?: typeof _existsSync);
    /**
