...
const constructTransformerChain = (options) => {
    ...
    return [
        ...
        new graphql_conversation_transformer_1.ConversationTransformer(modelTransformer, hasManyTransformer, belongsToTransformer, authTransformer, options === null || options === void 0 ? void 0 : options.outputStorageStrategy, options === null || options === void 0 ? void 0 : options.functionNameMap),
