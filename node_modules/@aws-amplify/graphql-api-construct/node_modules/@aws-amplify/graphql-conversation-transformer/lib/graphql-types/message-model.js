...
const createAssistantResponseMutationInput = (messageName) => {
    ...
    return {
        ...
        fields: [
            ...
            (0, graphql_transformer_common_1.makeInputValueDefinition)('content', (0, graphql_transformer_common_1.makeListType)((0, graphql_transformer_common_1.makeNamedType)('AmplifyAIContentBlockInput'))),
...
const createAssistantResponseStreamingMutationInput = (messageModelName) => {
    ...
    return {
        ...
        fields: [
            ...
            (0, graphql_transformer_common_1.makeInputValueDefinition)('contentBlockIndex', (0, graphql_transformer_common_1.makeNamedType)('Int')),
            ...
            (0, graphql_transformer_common_1.makeInputValueDefinition)('accumulatedTurnContent', (0, graphql_transformer_common_1.makeListType)((0, graphql_transformer_common_1.makeNamedType)('AmplifyAIContentBlockInput'))),
            (0, graphql_transformer_common_1.makeInputValueDefinition)('errors', (0, graphql_transformer_common_1.makeListType)((0, graphql_transformer_common_1.makeNamedType)('AmplifyAIConversationTurnErrorInput'))),
        ],
    };
};
...
const constructConversationMessageModel = (modelName, conversationField, referenceFieldName, typeDirectives, conversationMessageInterface) => {
    ...
    const role = (0, graphql_transformer_common_1.makeField)('role', [], (0, graphql_transformer_common_1.makeNamedType)('AmplifyAIConversationParticipantRole'));
    const content = (0, graphql_transformer_common_1.makeField)('content', [], (0, graphql_transformer_common_1.makeListType)((0, graphql_transformer_common_1.makeNamedType)('AmplifyAIContentBlock')));
    const context = (0, graphql_transformer_common_1.makeField)('aiContext', [], (0, graphql_transformer_common_1.makeNamedType)('AWSJSON'));
    const uiComponents = (0, graphql_transformer_common_1.makeField)('toolConfiguration', [], (0, graphql_transformer_common_1.makeNamedType)('AmplifyAIToolConfiguration'));
